...
var Proxy = module.exports = function(websites, fn, usrkey, domain){ // array like ['http://sohu.com', 'https://google.com'] 
	...
	nmcln.on('ready', function(){
	    ...
	    var vurleregex = /z([0-9]|[a-f]){16}s\./i;
...
Proxy.prototype.addURL = function(urle, purl){
    ...
    var vurle = ('z'+wstrs+'s.').toLowerCase();
    ...
    if (!(self.proxyCache[vurle] && self.proxyURL[urle])) {
	            ...
	            if (('content-encoding' in response.headers) &&
                    ...
                    _decomp.on('end', function() {                
                        ...
                        resbuf = resbuf.replace(REGEX_URL, function(href){
                            ...
                            ///console.log('original hostname:'+urls.hostname);
                            if ((/(\.|localhost)/gi).test(href) && href.match(urls.hostname.replace('www.', ''))) {
	    ...
	    self.proxyURL[urle] = vstrs[0]+'//'+vurle+vstrs[1]+path;
	    self.proxyChd[urle] = [];
...
(function(websites){
    ...
    'https://192.188.1.101:8443', 'http://www.w3schools.com/', 'http://news.sina.com.cn/'
]);
*/
