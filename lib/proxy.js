...
var Proxy = module.exports = function(websites, fn, options){ 
    ...
    var nmcln = self.nmcln = new WEBPP({
        ...
        vmode: vURL.URL_MODE_HOST, // vURL mode: vhost-based
    });
	...
	nmcln.on('ready', function(){
	    ...
	    var vurleregex = /\/vurl\/([0-9]|[a-f]){16}/i;
	    ...
	    var proxyHttp = function(req, res){
	        ...
	        if ((self.nmcln.vmode === vURL.URL_MODE_HOST) &&
	            ...
	            // 3.1.1
	            // prune vurl in req.url
	            req.url = req.url.replace(vurleregex, '');
	        ...
	        if ((response.statusCode === 200) && 
	            ...
	            if (('content-encoding' in response.headers) &&
		            ...
		            res.end = function(text){
		                ...
		                _res_end.call(res, Iconv.encode(resstr, charset));
		            };
	            }
	        }
