...
var Proxy = module.exports = function(websites, fn, usrkey, domain){ // array like ['http://sohu.com', 'https://google.com'] 
	...
	nmcln.on('ready', function(){
	    ...
	    for (var idx = 0; idx < websites.length; idx ++) {
            ...
            // TBD... overwrite href from text/html response for whole website proxy
            
            // TBD... redirection to another host
		    
		    // vhost-based vURL
		    self.proxyURL[websites[idx]] = vstrs[0]+'//'+vurle+vstrs[1]+path;
	    }
...
(function(websites){
    ...
    'https://192.188.1.101:8443', 'http://www.w3school.com.cn', 'http://news.sina.com.cn/'
]);
*/
