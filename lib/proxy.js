...
var Proxy = module.exports = function(websites, fn, usrkey, domain){ // array like ['http://sohu.com', 'https://google.com'] 
	...
	nmcln.on('ready', function(){
	    ...
	    for (var idx = 0; idx < websites.length; idx ++) {
		    ...
		    var wstrs = (proto+urls.host).replace(/:/gi, '-').replace(/\./gi,'-');
		    var vurle = wstrs+'.';
		    ...
		    // vhost-based vURL
		    self.proxyURL[websites[idx]] = vstrs[0]+'//'+wstrs+'.'+vstrs[1]+path;
	    }
...
(function(websites){
    ...
    'https://192.188.1.101:8443', 'http://www.w3school.com.cn', 'http://v.youku.com/v_show/id_XNTMzMjg4Nzky.html'
]);
*/
